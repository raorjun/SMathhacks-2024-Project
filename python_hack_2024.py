...
pakistan_soil = pd.read_csv(r"C:\Users\raorj\Documents\SMathhacks-2024-Project\Croptimizer\pakistan_soils.csv")
...
if(st.button('Learn more about Croptimizer!')):
    ...
    st.image('https://media.npr.org/assets/img/2022/08/29/gettyimages-1242738982_custom-443c2892eb4ca3bb2a68e31aeb7f3f1368d3f5d2.jpg')
...
with st.expander("""Are you a farmer in Pakistan?"""):
    ...
    if (st.button('See your Results')):
        ...
        data_p = pd.read_csv(r'"C:\Users\raorj\Documents\SMathhacks-2024-Project\Croptimizer\rf_values.csv"')
    ...
    if(st.button('See Original Values')):
        p_data = pd.read_csv(r'"C:\Users\raorj\Documents\SMathhacks-2024-Project\Croptimizer\p_data.csv"')
...
data = pd.read_csv(r'"C:\Users\raorj\Documents\SMathhacks-2024-Project\Croptimizer\Crop_recommendation.csv"')
...
with st.expander("Nutrient Additive Calculator"):
    ...
    """)
    data_nut = pd.read_csv(r'"C:\Users\raorj\Documents\SMathhacks-2024-Project\Croptimizer\soil_hack_data.csv"')
    liters = st.number_input("Input the amount of water in liters:", 1)
    crop_nut = st.selectbox("Which crop?", options = np.array(['Cotton', 'Rice', 'Sugarcane', 'Wheat', 'Barley', 'Legumes', 'Sorghum', 'Leafy Vegetables',
                                                    'Tomatoes', 'Cucumbers']))
...
#st.image('C:\Users\laira\AppData\Local\Temp\52fb17ef-ece3-411c-943c-6d3970a7f052_png2jpg.zip.052\Farming_Logo.jpg')
