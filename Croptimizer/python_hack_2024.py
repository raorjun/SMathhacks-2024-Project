...
pakistan_soil = pd.read_csv(r"C:\Users\laira\Downloads\pakistan_soils.csv")
...
with st.expander("""Are you a farmer in Pakistan?"""):
    ...
    if (st.button('See your Results')):
        ...
        data_p = pd.read_csv(r'C:\Users\laira\Downloads\rf_values - Sheet1.csv')
    ...
    if(st.button('See Original Values')):
        p_data = pd.read_csv(r'C:\Users\laira\Downloads\p_data.csv')
...
data = pd.read_csv(r'C:\Users\laira\Downloads\Crop_recommendation.csv')
...
with st.expander("Nutrient Additive Calculator"):
    ...
    """)
    data_nut = pd.read_csv(r'C:\Users\laira\Downloads\soil_hack_data.csv')
